...
landmarks= np.array([[70.0,70.0],[41,65],[60,80]])
# landmarks= np.array([[70.0,70.0],[41,65],[60,80],[60,40],[60,50],[70,40],[70,80]])
...
# else:
particles = create_uniform_particles((50,70), (60,80), N)
weights = np.ones(N) / N
