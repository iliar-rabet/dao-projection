...
with open(filepath) as fp:
   for line in fp:
        ...
        if(int(line.split()[0])>mobile_nodes):
...
class MN:
    def __init__(self):
        ...
        self.sum_err=0
        self.new_parent=""
        self.old_parent="fd00:0:0:0:212:7401:1:101"
