...
static char addr_str[56], long_str[100], *shared_memory; //, buff[100], curr_parent[100], msg_cntr[2] = {0};
//const char wait[4] = "WAIT";

static struct ctimer read_timer;
//static uip_ipaddr_t old_parent, uip_ipaddr_t;
//static struct sockaddr_in serv_addr;
static struct simple_udp_connection rssi_conn, data_conn;
...
/*
static void read_func(void *ptr){ 
