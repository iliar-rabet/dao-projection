...
<simconf>
  ...
  <simulation>
    ...
    <mote>
      ...
      <interface_config>
        ...
        <x>11.283639803448066</x>
        <y>11.2399996223997</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>21.744750469104247 0.0 0.0 21.744750469104247 -89.37005514343717 -7.172193385022448</viewport>
    </plugin_config>
    <width>400</width>
    <z>2</z>
    <height>400</height>
  ...
  <plugin>
    Mobility
    <plugin_config>
      <positions EXPORT="copy">[CONFIG_DIR]/../../pymobility/random-5.dat</positions>
    </plugin_config>
    <width>500</width>
    <z>4</z>
    <height>200</height>
